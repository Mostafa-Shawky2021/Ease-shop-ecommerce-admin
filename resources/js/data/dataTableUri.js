const dataTableUri = {
    ...
    DELETE_COLORS: "/admin/colors/delete",
    DELETE_BRANDS: "/admin/brands/delete",
    DELETE_ORDERS: "/admin/orders/delete",
    RESTORE_PRODUCTS: "/admin/products/restore",
    DELETE_NOTIFICATIONS: "/admin/notifications/delete",
    DELETE_MESSAGES: "/admin/messages/delete",
};
